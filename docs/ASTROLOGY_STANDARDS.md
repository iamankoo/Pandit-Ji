...
Version: 1.5.0 (Phase 7 methodology lock, on top of the v1.4.1 Nakshatra/Pada boundary-convention clarification and the v1.4.0 Phase 6 lock — see §Versioning at the end of this document for the change log).
