...
Version: 1.4.1 (Nakshatra/Pada boundary-convention clarification on top of the v1.4.0 Phase 6 pre-implementation lock — see §Versioning at the end of this document for the change log).
